...
namespace ServiceCo
{
    public partial class Commuter_EmailOTP : ContentPage
    {
        ...
        public Commuter_EmailOTP(string currentEmail, string newEmail, string phoneNumber)
        {
            InitializeComponent();
        ...
        private async Task VerifyOTP()
        {
            ...
            try
            {
                ...
                await _firebaseEmail.UpdateCommuterEmailAsync(commuterId, _newEmail);
        ...
        private async Task ShowModal(string title, string message, string type, bool closePageOnOk)
        {
            ...
            var modal = new CommuterCustomModalPage(modalContent, blurOverlay, closePageOnOk, type, this);
        ...
        private async Task ShowExitConfirmation()
        {
            ...
            var exitModal = new CommuterExitConfirmationModalPage(modalContent, blurOverlay, this);
    ...
    public class CommuterCustomModalPage : ContentPage
    {
        private Frame _modalContent;
        private Grid _blurOverlay;
        private bool _closePageOnOk;
        private string _modalType;
        private Commuter_EmailOTP _parentPage;

        public CommuterCustomModalPage(Frame modalContent, Grid blurOverlay, bool closePageOnOk, string modalType, Commuter_EmailOTP parentPage)
        {
    ...
    public class CommuterExitConfirmationModalPage : ContentPage
    {
        private Frame _modalContent;
        private Grid _blurOverlay;
        private Commuter_EmailOTP _parentPage;

        public CommuterExitConfirmationModalPage(Frame modalContent, Grid blurOverlay, Commuter_EmailOTP parentPage)
        {
            _modalContent = modalContent;
            _blurOverlay = blurOverlay;
            _parentPage = parentPage;
    ...
    public static class CommuterGridExtensions
    {
        public static Button WithCommuterGridColumn(this Button button, int column)
        {
