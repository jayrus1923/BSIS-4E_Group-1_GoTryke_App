...
namespace ServiceCo
{
    public partial class Driver_ChangePIN : ContentPage
    {
        ...
        private async Task ShowExitConfirmation()
        {
                        ...
                        new Grid
                        {
                            ...
                            Children =
                            {
                                new Button
                                {
                                    ...
                                    FontSize = 14,
                                    FontAttributes = FontAttributes.Bold
                                }.WithDriverChangePinGridColumn(0),
                                new Button
                                {
                                    Text = "EXIT",
                                    ...
                                    FontSize = 14,
                                    FontAttributes = FontAttributes.Bold
                                }.WithDriverChangePinGridColumn(1)
                            }
                        }
                    }
                }
            ...
            var exitModal = new DriverChangePinExitConfirmationModalPage(modalContent, blurOverlay, this);
        ...
        private async void OnUpdatePinClicked(object? sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (driver == null)
                {
                    ...
                    _isProcessing = false;
                    _isModalOpen = false;
                    await ShowModal("Error", "Driver not found.", "warning", false);
                    return;
                }

                if (driver.Pin != currentPin)
                {
                    HideProcessing();
                    _isProcessing = false;
                    _isModalOpen = false;
                ...
                bool success = await _firebaseConnection.UpdateDriverPinCodeAsync(driverId, newPin);
        ...
        private async Task ShowModal(string title, string message, string type, bool closePageOnOk)
        {
            ...
            var modal = new DriverChangePinCustomModalPage(modalContent, blurOverlay, closePageOnOk, this);
    ...
    public class DriverChangePinCustomModalPage : ContentPage
    {
        private Frame _modalContent;
        private Grid _blurOverlay;
        private bool _closePageOnOk;
        private Driver_ChangePIN _parentPage;

        public DriverChangePinCustomModalPage(Frame modalContent, Grid blurOverlay, bool closePageOnOk, Driver_ChangePIN parentPage)
        {
    ...
    public class DriverChangePinExitConfirmationModalPage : ContentPage
    {
        private Frame _modalContent;
        private Grid _blurOverlay;
        private Driver_ChangePIN _parentPage;

        public DriverChangePinExitConfirmationModalPage(Frame modalContent, Grid blurOverlay, Driver_ChangePIN parentPage)
        {
            _modalContent = modalContent;
            _blurOverlay = blurOverlay;
            _parentPage = parentPage;
    ...
    public static class DriverChangePinGridExtensions
    {
        public static Button WithDriverChangePinGridColumn(this Button button, int column)
        {
